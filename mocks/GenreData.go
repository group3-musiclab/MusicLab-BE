...
// GenreData is an autogenerated mock type for the GenreData type
type GenreData struct {
	mock.Mock
}

// AddMentorGenre provides a mock function with given fields: newGenre
func (_m *GenreData) AddMentorGenre(newGenre genres.Core) error {
...
func (_m *GenreData) Delete(mentorID uint, genreID uint) error {
...
func (_m *GenreData) GetGenre() ([]genres.Core, error) {
	ret := _m.Called()
...
func (_m *GenreData) GetMentorGenre(mentorID uint) ([]genres.MentorGenreCore, error) {
...
type mockConstructorTestingTNewGenreData interface {
	mock.TestingT
	Cleanup(func())
}

// NewGenreData creates a new instance of GenreData. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewGenreData(t mockConstructorTestingTNewGenreData) *GenreData {
	mock := &GenreData{}
	mock.Mock.Test(t)
